...
public class Maker {
    ...
    public JLabel LabelMaker(int X_Bounds,int Y_Bounds,int W_Bounds,int H_Bounds,String titel,Color color) {
        ...
        label.setBounds(X_Bounds, Y_Bounds, W_Bounds, H_Bounds);
